...
LOCAL	bool	expand_set(POINTER*,int);
...
EXPORT  bool _unique_add_to_pointers(
	POINTER	newp,
	POINTER	**parray)
{
...
EXPORT  bool _add_to_ordered_pointers(
	POINTER		newp,
	POINTER		antep,
	POINTER		**parray)
{
...
EXPORT bool _delete_from_pointers(
	POINTER		p,
	POINTER		**parray)
{
	POINTER		*q;
...
EXPORT bool _delete_from_pointers_if_present(
	POINTER		p,
	POINTER		**parray)
{
...
EXPORT bool _delete_from_ordered_pointers(
	POINTER		p,
	POINTER		**parray)
{
	POINTER	*q, *array;
...
EXPORT bool _delete_from_ordered_pointers_at_location(
	int		i,
	POINTER		**parray)
{
	POINTER		*q;
...
EXPORT  bool _pointer_is_in_array(
	POINTER	p,
	POINTER	*parray)
{
	POINTER		*q;
...
EXPORT  bool _index_of_pointer_in_array(
	POINTER	p,
	POINTER	*parray,
	int     *pi)
{
