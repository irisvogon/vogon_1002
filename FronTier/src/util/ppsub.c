...
SYNOPSIS
	...
	pp_global_sum():	sums a distributed float uni_array
	pp_global_max():	maximum of a global float uni_array
	pp_global_min():	minimum of a global float uni_array
...
#if defined(__MPI__)
LOCAL	size_t MSG_BUF_SIZE = 32000000;
#endif /* defined(__MPI__) */
	...
	bool	status)
{
...

	{
	    ...
	    if (allstats == NULL)
	    	uni_array(&allstats,n,sizeof(bool));
