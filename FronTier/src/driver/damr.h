...
struct _CHART {
	...
	int (*hyp_solver)(float,float*,Wave*,Front*);
	int (*parab)(float,float*,Wave*,Front*);
        void (*subgrid)(float,Front*,Wave*);
        void (*set_up_merge_cell)(Wave*);
        void (*update_merge_cell)(float,Wave*,Front*);
#if defined (USE_OVERTURE)
