...
LOCAL	bool    consistent_params1d(INTERFACE*);
...
LOCAL	void	oned_riemann_problem(Locstate,Locstate,Locstate,Locstate,
				     ...
				     RIEMANN_SOLVER_WAVE_TYPE*,float*);
	...
	CROSS *cr)
{
	...
	bool                     track_new_wave[7];
	bool                     reduce_time_step;
	int		         n_new_waves;
	int                      np, i;
...
LOCAL bool consistent_params1d(
	INTERFACE *intfc)
{
	POINT **p;
	int   i, np;
