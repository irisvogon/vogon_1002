...
LOCAL	void	cc_set_uswssten2(USWSSten2d*,POINT*,HYPER_SURF_ELEMENT*,
			         HYPER_SURF*,Front*,Wave*,float);
LOCAL	bool	cc_identify_curves_at_node(NODE*,NODE*,O_CURVE**,O_CURVE**,
					   Front*);
LOCAL	void	cc_compute_states_at_crossing_bonds(NODE*,O_CURVE**,O_CURVE**,
						    BOND**,float*,Front*,
						    Wave*,float);
LOCAL	void	cc_normal(POINT*,HYPER_SURF_ELEMENT*,HYPER_SURF*,float*,
			  Front*);
LOCAL	void	cc_tangent(POINT*,BOND*,CURVE*,float*,Front*);
...
LOCAL	void	cc_node_point_propagate2(Front*,Wave*,POINT*,POINT*,
					 HYPER_SURF_ELEMENT*,HYPER_SURF*,
					 float,float*);
LOCAL	void	cc_compute_net_normal_at_node(float*,O_CURVE**,
					      O_CURVE**,Front*);
...
LOCAL	float	cc_nor[3];
LOCAL	float	cc_tan[3];
...
LOCAL	bool	cc_identify_curves_at_node(
	NODE	*oldn,
	NODE	*newn,
	O_CURVE	**oldc,
	O_CURVE	**newc,
	...
	float	dt)
{
	...
	bool		sav_interpolate = interpolate_intfc_states(intfc);
