...
LOCAL	OUTPUT_VALUE	*ses_ps_prt_soln(OUTPUT_SOLN*,float*,int*);
LOCAL	OUTPUT_VALUE	*ses_re_prt_soln(OUTPUT_SOLN*,float*,int*);
LOCAL	OUTPUT_VALUE	*ses_rs_prt_soln(OUTPUT_SOLN*,float*,int*);
LOCAL	OUTPUT_VALUE	*ses_rt_prt_soln(OUTPUT_SOLN*,float*,int*);
...
LOCAL	void	ses_ps_restart_initializer(int*,COMPONENT,
					   INPUT_SOLN**,Locstate);
LOCAL	void	ses_ps_set_restart_intfc_states(float*,float*,int,POINT*,
	...
	int		sesame_table)
{
	...
	int		var;
	void		(*set_restart_intfc_states)(float*,float*,int,POINT*,
						    HYPER_SURF_ELEMENT*,
						    HYPER_SURF*);
