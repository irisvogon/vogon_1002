...
struct _STELLAR_EOS {
	...
	float	_xmass[MAX_NUM_ISOTOPS]; /* mass fractions of isotops */
	float	_aion[MAX_NUM_ISOTOPS]; /* atomic weight of isotops */
	float	_zion[MAX_NUM_ISOTOPS]; /* atomic number of isotops */
