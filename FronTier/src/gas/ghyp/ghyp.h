...
typedef struct {
	...
	float	***l;     /* left eigenuni_arrays */
	float	***r;     /* right engenuni_arrays */
	...
	struct {
	    ...
	    bool l;     /* left eigenuni_arrays */
	    bool r;     /* right engenuni_arrays */
	    bool vegn;
	} alloc;
} Vec_Eigen;
...
struct _MUSCL_FLUX {
	...
	float   **H;    /* Line flux uni_arrays, see the documentation above   */
};
