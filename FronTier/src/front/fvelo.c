        ...
        int dim)
{
        ...
        char s[10];
        float wind[MAXD],x0,y0,omega_0,domega_dr;
	...
	float *vel)
{
        ...
        int i;
        float a, b;
        float theta, nor[MAXD], wind[MAXD];
        float ssin,scos;
        float speed;
        float alpha, U, c, m, epsilon;
        float t,temp;
	...
	float *vel)
{
	...
	float d1,d2;
	float s1,s2;
	float *cen1 = bipolar_params->cen1;
	float *cen2 = bipolar_params->cen2;
	float dx1,dy1;
	float dx2,dy2;
	float rev_time = bipolar_params->reverse_time;
        ...
        float *vel)
{
        ...
        int i, dim;
        float coeff,coeff2,xtemp,ytemp;
        char *type;
        float *coords = Coords(p);
