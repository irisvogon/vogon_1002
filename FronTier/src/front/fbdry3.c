...
LOCAL	void	find_bdry_curves_at_node(NODE*,CURVE**,ORIENTATION*,
					CURVE**,ORIENTATION*);
LOCAL	bool 	remove_ext_curve_at_single_bdry(Front*,CURVE*,CURVE*,
					NODE*,NODE*);
LOCAL	bool 	remove_ext_curve_at_corner(Front*,CURVE*,CURVE*,ORIENTATION,
...
LOCAL	bool remove_ext_curve_at_single_bdry(
	Front *fr,
	CURVE *c,
	CURVE *bc,
	NODE *ns,
...
LOCAL	bool remove_ext_curve_at_corner(
	Front *fr,
	CURVE *c,
	CURVE *bc1,
