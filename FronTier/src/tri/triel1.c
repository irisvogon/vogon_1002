...
LOCAL	bool	triangulate_blk(TRI_GRID*,int*,
				LINEAR_ELEMENT**,BILINEAR_ELEMENT**);
LOCAL	bool	triangulate_el00(TRI_GRID*,int,int*,int,int,int*,int,int,
...
EXPORT	bool fast_blk_triangulate(
	TRI_GRID	*ntg,
	int		*icoords,
	LINEAR_ELEMENT	**tri,
	BILINEAR_ELEMENT **qd)
...
LIB_LOCAL	bool triangulate_el0(
	TRI_GRID	*ntg,
	int		ncs,
	int		*s_list,
	int		jse,
